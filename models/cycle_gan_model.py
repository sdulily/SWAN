...
class CycleGANModel(BaseModel):
    ...
    def initialize(self, opt):
        ...
        self.netG_A = networks.define_G_A(opt.input_nc, opt.output_nc,
                                                   opt.ngf, opt.which_model_netG, opt.norm, not opt.no_dropout, opt.init_type,
                                                   self.gpu_ids)
        self.netG_B = networks.define_G_B(opt.output_nc, opt.input_nc,
    ...
    def backward_G(self, lambda_sup):
        ...
        loss_G = loss_G_A + loss_G_B + loss_cycle_A + loss_cycle_B + loss_idt_A + loss_idt_B + loss_G_ink  + loss_edge_1 + loss_style
        loss_G.backward()
